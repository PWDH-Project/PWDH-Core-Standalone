...
#ifndef PWDH_IPC_CAPNP_COMMON_TYPES_H
#define PWDH_IPC_CAPNP_COMMON_TYPES_H
...
//! Functions to serialize / deserialize common pwdh types.
namespace mp {
...
#endif // PWDH_IPC_CAPNP_COMMON_TYPES_H
