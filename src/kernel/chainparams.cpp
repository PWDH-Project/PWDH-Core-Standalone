...
{
    const char* pszTimestamp = "PWDH Community forever , since 1998 | 2026-03-07";
...
public:
    CMainParams() {
        ...
        consensus.nRuleChangeActivationThreshold = 7258;
        ...
        consensus.nPowTargetTimespan = 5 * consensus.nPowTargetSpacing;
        ...
        genesis = CreateGenesisBlock(1772841600, 0, 0x207fffff, 1, 35 * COIN);
        ...
        vSeeds.emplace_back("seed01.pwdh.org.");
        vSeeds.emplace_back("seed02.pwdh.org.");
        vSeeds.emplace_back("seed03.pwdh.org.");
        vSeeds.emplace_back("seed04.pwdh.org.");
        vSeeds.emplace_back("seed05.pwdh.org.");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1772841601, 6, 0x207fffff, 1, 35 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.emplace_back("testnet.pwdh.ddns.net.");
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        genesis = CreateGenesisBlock(1772841602, 3, 0x207fffff, 1, 35 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
