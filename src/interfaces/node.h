...
#ifndef PWDH_INTERFACES_NODE_H
#define PWDH_INTERFACES_NODE_H
...
//! Top-level interface for a pwdh node (pwdhd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or pwdh.conf.
