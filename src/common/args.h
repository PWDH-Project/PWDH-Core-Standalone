...
#ifndef PWDH_COMMON_ARGS_H
#define PWDH_COMMON_ARGS_H
...
extern const char * const PWDH_CONF_FILENAME;
extern const char * const PWDH_SETTINGS_FILENAME;
