 ...
 * for both pwdhd and pwdh-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("PWDH");
...
/**
 * Format the subversion field according to the BIP 14 spec.
 */
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/PWDH-Project/PWDH-Core>";
