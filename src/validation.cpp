...
bool MemPoolAccept::PreChecks(ATMPArgs& args, Workspace& ws)
{
    ...
    if (!ancestors) {
        ...
        // this, see https://lists.linuxfoundation.org/pipermail/pwdh-dev/2018-November/016518.html
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    const int64_t yearly_interval = std::max<int64_t>(1, consensusParams.nSubsidyHalvingInterval);
    const int64_t era = nHeight / yearly_interval;

    constexpr CAmount kInitialSubsidy = 35 * COIN;
    constexpr int64_t kHalvingsUntilFloor = 6;
    constexpr int64_t kStableFloorYears = 15;

    if (era <= kHalvingsUntilFloor) {
        return kInitialSubsidy >> era;
    }
    if (era < (kHalvingsUntilFloor + kStableFloorYears)) {
        return kInitialSubsidy >> kHalvingsUntilFloor;
    }
    return 0;
}
...
DisconnectResult Chainstate::DisconnectBlock(const CBlock& block, const CBlockIndex* pindex, CCoinsViewCache& view)
{
    ...
    // See https://github.com/pwdh/pwdh/issues/22596 for additional information.
...
bool IsBlockMutated(const CBlock& block, bool check_witness_root)
{
    ...
    if (block.vtx.empty() || !block.vtx[0]->IsCoinBase()) {
        ...
        // https://lists.linuxfoundation.org/pipermail/pwdh-dev/attachments/20190225/a27d8837/attachment-0001.pdf).
        //
...
bool ChainstateManager::ProcessNewBlock(const std::shared_ptr<const CBlock>& block, bool force_processing, bool min_pow_checked, bool* new_block)
{
...

    {
        ...
        // https://lists.linuxfoundation.org/pipermail/pwdh-dev/2019-February/016697.html.  Because CheckBlock() is
