...
#ifndef PWDH_QT_PWDHGUI_H
#define PWDH_QT_PWDHGUI_H
...
/**
  PWDH GUI main class. This class represents the main window of the PWDH UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PWDHGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit PWDHGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~PWDHGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a pwdh wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, PWDHUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed PWDH Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(PWDHUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // PWDH_QT_PWDHGUI_H
