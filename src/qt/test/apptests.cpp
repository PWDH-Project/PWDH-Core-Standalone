...
//! Entry point for PWDHApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &PWDHApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for PWDHGUI tests.
void AppTests::guiTests(PWDHGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &PWDHGUI::consoleShown, this, &AppTests::consoleTests);
