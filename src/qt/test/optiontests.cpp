...
{
    // Test regression https://github.com/pwdh/pwdh/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/pwdh-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/pwdh-core/gui/pull/568.
    // With fListen=false in ~/.config/PWDH/PWDH-Qt.conf and all else left as default,
    // pwdh-qt should set both -listen and -listenonion to false and start successfully.
