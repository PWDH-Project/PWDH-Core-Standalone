      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->pwdhAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->pwdhAtStartup);
    ...
    ui->pwdhAtStartup->setToolTip(ui->pwdhAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->pwdhAtStartup->setText(ui->pwdhAtStartup->text().arg(PACKAGE_NAME));

    ui->openPWDHConfButton->setToolTip(ui->openPWDHConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new PWDHUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->pwdhAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openPWDHConfButton_clicked()
{
