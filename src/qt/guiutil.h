...
#ifndef PWDH_QT_GUIUTIL_H
#define PWDH_QT_GUIUTIL_H
...
/** Utility functions used by the PWDH Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "pwdh:" URI into recipient object, return true on successful parsing
