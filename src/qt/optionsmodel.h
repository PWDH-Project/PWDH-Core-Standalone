...
#ifndef PWDH_QT_OPTIONSMODEL_H
#define PWDH_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for PWDH client.
...
public:
    ...
    PWDHUnit getDisplayUnit() const { return m_display_pwdh_unit; }
...
Q_SIGNALS:
    void displayUnitChanged(PWDHUnit unit);
