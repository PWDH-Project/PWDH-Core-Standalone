...
{
    BOOST_CHECK(TestSplitHost("www.pwdhcore.org", "www.pwdhcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.pwdhcore.org]", "www.pwdhcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.pwdhcore.org:80", "www.pwdhcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.pwdhcore.org]:80", "www.pwdhcore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.pwdhcore.org:65536", "www.pwdhcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.pwdhcore.org:0", "www.pwdhcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.pwdhcore.org:", "www.pwdhcore.org:", 0, false));
}
