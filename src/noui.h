...
/** Connect all pwdhd signal handlers */
void noui_connect();

/** Redirect all pwdhd signal handlers to LogPrintf. Used to check or suppress output during test runs that produce expected errors */
