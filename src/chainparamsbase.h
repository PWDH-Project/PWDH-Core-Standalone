...
#ifndef PWDH_CHAINPARAMSBASE_H
#define PWDH_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between pwdh-cli and pwdhd)
