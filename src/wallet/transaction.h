...
#ifndef PWDH_WALLET_TRANSACTION_H
#define PWDH_WALLET_TRANSACTION_H
...
public:
     ...
     * on this pwdh node, and set to 0 for transactions that were created
...
#endif // PWDH_WALLET_TRANSACTION_H
