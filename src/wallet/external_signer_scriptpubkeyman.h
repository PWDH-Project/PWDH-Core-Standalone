...
#ifndef PWDH_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define PWDH_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // PWDH_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
