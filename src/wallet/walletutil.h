...
#ifndef PWDH_WALLET_WALLETUTIL_H
#define PWDH_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! pwdh from opening the wallet, thinking it was newly created, and
...
#endif // PWDH_WALLET_WALLETUTIL_H
