...
"""Verify that starting pwdh with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pwdh with -h for help text")
        ...
        self.log.info("Start pwdh with -version for version information")
        ...
        self.log.info("Start pwdhd with -fakearg to make sure it does not start")
