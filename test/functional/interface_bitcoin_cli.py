...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `pwdh-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and pwdh-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and pwdh-cli getwalletinfo return expected wallet info")
            ...
            # Test pwdh-cli -generate with -rpcwallet in multiwallet mode.
