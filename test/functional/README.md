...
- The oldest supported Python version is specified in [doc/dependencies.md](/doc/dependencies.md).
  ...
  The CI linter job also checks this, but [possibly not in all cases](https://github.com/pwdh/pwdh/pull/14884#discussion_r239585126).
...
with the pwdhd(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a pwdhd.  `P2PInterface`
...
Taken from the [python-pwdhrpc repository](https://github.com/jgarzik/python-pwdhrpc).
...
Test objects for interacting with a pwdhd node over the p2p interface.

#### [script.py](test_framework/script.py)
Utilities for manipulating transaction scripts (originally from python-pwdhlib)
