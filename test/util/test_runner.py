...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "pwdh-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./pwdh-util":
        execprog = os.getenv("PWDHUTIL", default=execprog)
    elif testObj["exec"] == "./pwdh-tx":
        execprog = os.getenv("PWDHTX", default=execprog)
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, pwdh-tx
