...
complete --command pwdhd --no-files

# Extract options
function __fish_pwdhd_get_options
...
complete \
    --command pwdhd \
    --arguments "(__fish_pwdhd_get_options --nofiles)"
