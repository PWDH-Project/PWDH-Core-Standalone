...
# Extract options
function __fish_pwdh_tx_get_options
...
# Extract commands
function __fish_pwdh_tx_get_commands
...
complete \
    --command pwdh-tx \
    --condition "not __fish_pwdh_seen_cmd (__fish_pwdh_tx_get_commands --commandsonly)" \
    --arguments "(__fish_pwdh_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command pwdh-tx \
    --arguments "(__fish_pwdh_tx_get_commands)" \
    --no-files
