...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef PWDH_CHAINPARAMSSEEDS_H\n')
    g.write('#define PWDH_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the pwdh network\n')
    ...
    g.write('#endif // PWDH_CHAINPARAMSSEEDS_H\n')
