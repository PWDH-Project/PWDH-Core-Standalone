...
(
    ...
    case "$HOST" in
        *mingw*)
            make deploy ${V:+V=1} PWDH_WIN_INSTALLER="${OUTDIR}/${DISTNAME}-win64-setup-unsigned.exe"
            ;;
    esac
    ...
    (
        ...
        # copy over the example pwdh.conf file. if contrib/devtools/gen-pwdh-conf.sh
        # has not been run before buildling, this file will be a stub
        cp "${DISTSRC}/share/examples/pwdh.conf" "${DISTNAME}/"
