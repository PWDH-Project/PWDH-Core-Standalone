...
This means one can have an always-on pwdhd instance running, and another local pwdhd/pwdh-qt instance which connects to this node and receives blocks from it.
