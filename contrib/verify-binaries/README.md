...
of the [guix.sigs repository](https://github.com/pwdh-core/guix.sigs/). When
...
builder-keys](https://github.com/pwdh-core/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://pwdhcore.org and https://pwdh.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/pwdh-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/pwdh-24.0.1-arm-linux-gnueabihf.tar.gz
```
