...
signature file SHA256SUMS.asc from pwdhcore.org and pwdh.org and
compares them.
...
The builder keys are available in the guix.sigs repo:
    ...
    https://github.com/pwdh-core/guix.sigs/tree/main/builder-keys
...
HOST1 = "https://pwdhcore.org"
HOST2 = "https://pwdh.org"
VERSIONPREFIX = "pwdh-core-"
...
def verify_published_handler(args: argparse.Namespace) -> ReturnCode:
    WORKINGDIR = Path(tempfile.gettempdir()) / f"pwdh_verify_binaries.{args.version}"
    ...
    # remove binaries that are known not to be hosted by pwdhcore.org
...
def main():
    ...
    pub_parser.add_argument(
        'version', type=str, help=(
            f'version of the pwdh release to download; of the format '
    ...
    pub_parser.add_argument(
        ...
        help=(
            ...
            '(Sometimes pwdh.org lags behind pwdhcore.org.)')
    )
