...
def parse_config_into_bc2_config():
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/pwdh_config.h.in'), "r", encoding="utf8") as template_file:
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/pwdh_config.h'), "w", encoding="utf8") as bc2_config:
...
def main():
    ...
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/pwdh_config.h'), os.path.join(SOURCE_DIR, 'config/pwdh-config.h'))
