...
export CONTAINER_NAME=ci_native_nowallet_libpwdhkernel
...
export GOAL="install"
export PWDH_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
